...
$showFiles = $false         # Sätt till $true för att visa filer, $false för att bara visa mappar
$maxDepth = 2              # Hur många nivåer djupt skriptet ska gå i undermapparna
...
$excludeDirs = @(
    ...
    "extracted_data", "converted_docs", "Compatibility_Trainingdata", "compatibility", "Data",
